...
var Uom = require("../../data-util/master/uom-data-util");
var UomManager = require("../../../src/managers/master/uom-manager");
var instanceManager = null;
var validate = require("dl-models").validator.master.uom;
...
it("#01. should error when create new uom with empty data", function(done) {
...
it("#04. should error when create new data with same unit", function(done) {
...
it("#07. should error when update new data with same unit", function(done) {
    ...
    Uom.getNewData()
        ...
        .then((newData) => {
            ...
            newData.unit = createdData.unit;
            return instanceManager.update(newData);
        })
        .then((id) => {
            done("Should not be able to update data with same unit");
        })
        .catch((e) => {
            try {
                e.errors.should.have.property("unit");
