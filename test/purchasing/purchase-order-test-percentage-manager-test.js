...
var PurchaseOrderTestPercentageManager = require("../../src/managers/po/purchase-order-test-percentage-manager");
...
before('#00. connect db', function (done) {
    helper.getDb()
        .then(db => {
            instanceManager = new PurchaseOrderTestPercentageManager(db, {
                username: 'unit-test'
            });
            done();
        })
