    ...
    load(data) {
        return sqlConnect.getConnect()
            .then((request) => {
                ...
                var deleteTempTable = ('DELETE FROM [fact pembelian temp]; ')
