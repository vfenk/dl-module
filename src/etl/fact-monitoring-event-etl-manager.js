...
module.exports = class FactMonitoringEventEtlManager extends BaseManager {
    ...
    transform(data) {
        var result = data.map((item) => {
            ...
            var operationRange = moment(end).diff(moment(start), "hours");
            ...
            return {
                ...
                machineEventName: monitoringEvent.machineEvent.name ? `'${monitoringEvent.machineEvent.name}'` : null,
                eventRange: monitoringEvent.dateEnd ? `'${operationRange}'` : null
            }
        });
