            ...
            if (item.purchaseOrder) {
                ...
                var results = purchaseRequest.items.map((poItem) => {
                    ...
                    return {
                        ...
                        purchaseRequestDate: `'${moment(purchaseRequest.date).format('L')}'`,
                        expectedPRDeliveryDate: `'${moment(purchaseRequest.expectedDeliveryDate).format('L')}'`,
                        budgetCode: `'${purchaseRequest.budget.code}'`,
                        budgetName: `'${purchaseRequest.budget.name}'`,
                        unitCode: `'${purchaseRequest.unit.code}'`,
                        unitName: `'${purchaseRequest.unit.name}'`,
                        divisionCode: `'${purchaseRequest.unit.division.code}'`,
                        divisionName: `'${purchaseRequest.unit.division.name}'`,
                        categoryCode: `'${purchaseRequest.category.code}'`,
                        categoryName: `'${purchaseRequest.category.name}'`,
                        categoryType: `'${this.getCategoryType(catType)}'`,
                        productCode: `'${poItem.product.code}'`,
                        productName: `'${poItem.product.name.replace("'", ".")}'`,
