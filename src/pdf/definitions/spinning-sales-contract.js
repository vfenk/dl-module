        ...
        body = [
            {
                ...
                columns: [
                    ...
                    {
                        width: '*',
                        text: detail + salesContract.termOfPayment.termOfPayment,
                        style: ['size09']
                    }]
            }, {
                columns: [
            ...
            var subheader2 = [{
                stack: ['\n', {
                    ...
                    alignment: "left"
                        ...
                        text: 'Placed with us, P.T. DAN LIRIS - SOLO INDONESIA, is inclusive of ' + salesContract.comission + ' sales commission' + '\n' + 'each ' + salesContract.uom.unit + ' on the FOB - SEMARANG value, payable to you upon final negotiation and clearance of ' + salesContract.termOfPayment.termOfPayment + '.',
                        style: ['size09'],
                        alignment: "left"
                    }, '\n', '\n', {
