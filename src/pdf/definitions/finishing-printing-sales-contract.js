...
module.exports = function (salesContract) {
    ...
    for(var i of details){
        ...
        detail+= i.color + " " + i.currency.code + " " + `${parseFloat(i.price).toLocaleString(locale, locale.currency)}` + ' / ' + salesContract.uom.unit +"\n";
        detailprice+= i.currency.code + " " + `${parseFloat(i.price).toLocaleString(locale, locale.currency)}` + ' / ' + salesContract.uom.unit + ' ' + ppn + ' ' + '( ' + i.color + ' )' + "\n";
        amount+=i.price;
    }
    var comoDesc="";
